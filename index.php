...
<body>
  ...
  <div class="container">
        ...
        <nav class="sidebar">
          <ul class="side-nav ">
            ...
            <div class="dropdown ">
              ...
              <div class="dropdown-bttn side-nav__item">
                <a href="#"  class="side-nav__link">Engineering</a>
              </div>



              <ul>
                <li><a class="sbdrop" id="click" href="#">CSE</a></li>

                <li><a class="sbdrop" id="click2" href="#">EEE</a></li>

                <li><a class="sbdrop" href="#">Mechanical</a> </li>
              </ul>
    ...
    <footer class="site-footer">
      All copyrights reserved by DHS-Ruet
    </footer>
